...
import AccountManagement from '../../components/MobileManagementComponents/AccountManagement';
import SiswaPostsManagement from '../../components/MobileManagementComponents/SiswaPostsManagement';

const MobileManagement = () => {
    const [selectedTab, setSelectedTab] = useState(0);

    const tabs = [
        { name: 'Akun', component: AccountManagement },
        { name: 'Postingan', component: SiswaPostsManagement },
    ];

    return (
        <div className="min-h-full">
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-900">Manajemen Aplikasi Mobile</h1>
                <p className="mt-1 text-sm text-gray-500">
                    Kelola akun dan konten aplikasi mobile
                </p>
            </div>
