...
import { FiPlus, FiEdit2, FiTrash2, FiFileText, FiFilter, FiHeart, FiMessageSquare } from 'react-icons/fi';
        ...
        try {
            ...
            const postsWithCounts = await Promise.all(
                response.data.map(async (post) => {
                    ...
                    return {
                        ...post,
                        likes_count: likesRes.data.likes_count,
                                ...
                                {getFilteredPosts().map((post, index) => (
                                    ...
                                    >
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div className="flex items-center gap-3 text-gray-500 border-l pl-3">
